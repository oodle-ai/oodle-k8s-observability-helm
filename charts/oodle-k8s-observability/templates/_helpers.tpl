...
{{/*
Generate the scrape config content for vmagent (used for both ConfigMap and checksum)
This helper outputs the raw YAML content of the scrape configuration
*/}}
{{- define "oodle-k8s-observability.vmagentScrapeConfigContent" -}}
global:
  ...
  external_labels:
    {{- toYaml .Values.vmagent.managedScrapeConfig.external_labels | nindent 4 }}
...
{{/*
Compute sha256 checksum of the vmagent scrape configuration
This is used to trigger pod restarts when the scrape config changes
*/}}
{{- define "oodle-k8s-observability.vmagentScrapeConfigChecksum" -}}
{{- include "oodle-k8s-observability.vmagentScrapeConfigContent" . | sha256sum }}
{{- end }}
